...
class __Mustache_03aa08e5b188b868c004205086bc50f3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3510c410bdf849559f5a13c4562df57e($context, $indent, $value);
...
';
    ...
    private function section52627302a4860cd20ef65fa17f0016fa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{discussion.times.created}}, {{#str}}strftimedatemonthabbr, langconfig{{/str}}';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
    ...
    private function section880d26a18885305f1eab8df64a58e6bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section52627302a4860cd20ef65fa17f0016fa($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                                            </div>
';
...
';
    ...
    private function sectionFc444fec05c766df15b0668601d8b5a8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '{{discussion.times.modified}}, {{#str}}strftimedatemonthabbr, langconfig{{/str}}';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
    ...
    private function section564c1b6d4d2d93f6303e3d3e3c080f48(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                // 'userdate' section
                $value = $context->find('userdate');
                $buffer .= $this->sectionFc444fec05c766df15b0668601d8b5a8($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                                                    </a>
';
    ...
    private function sectionA11abd710cdb4d850609c496a3a58192(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section564c1b6d4d2d93f6303e3d3e3c080f48($context, $indent, $value);
                $buffer .= $indent . '                                            </div>
';
                $buffer .= $indent . '                                        </div>
';
...
';
    ...
    private function section4f59778b420b377f92bed66173cbff87(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section880d26a18885305f1eab8df64a58e6bb($context, $indent, $value);
                $buffer .= $indent . '                            </td>
';
...
';
                ...
                $buffer .= $this->sectionA11abd710cdb4d850609c496a3a58192($context, $indent, $value);
                $buffer .= $indent . '                            </td>
';
...
';
    ...
    private function section3510c410bdf849559f5a13c4562df57e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        ...
                        $buffer .= $this->section4f59778b420b377f92bed66173cbff87($context, $indent, $value);
                        $buffer .= $indent . '                </tbody>
';
                    }
                    $buffer .= $indent . '            </table>
