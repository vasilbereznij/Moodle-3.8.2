...
/**
 * Strings for component 'format_tiles', language 'uk', version '3.8'.
 *
...
$string['allowlabelconversion'] = 'Дозволити написи перетворювати на сторінку (експериментально)';
$string['allowlabelconversion_desc'] = 'Якщо буде позначено цей пункт, для редагування викладачам буде надано опцію в налаштуваннях редагування кожної мітки, щоб перетворити напис на сторінку. Це експериментальна установка.';
...
$string['blockedpopup'] = 'Ваш браузер заблокував спливаюче вікно. Дозвольте спливаючі вікна з цього сайту або натисніть посилання нижче, щоб відвідати сайт у цьому вікні';
$string['blockedpopuptitle'] = 'Блокування спливаючих вікон';
$string['brandcolour'] = 'Колір бренду';
$string['browserstorage'] = 'Сховище браузера';
...
$string['converttopage'] = 'Конвертувати до сторінки';
$string['converttopage_confirm'] = 'Ви впевнені? Це не може бути скасовано (вам доведеться створити мітку знову вручну, якщо потрібно).';
...
$string['experimentalsetting'] = '(експериментальне налаштування)';
...
$string['hovercolour'] = 'Колір плитки при наведенні';
$string['hovercolour_descr'] = 'Колір, який матиме плитка при наведенні на неї миші';
...
$string['jsmaxstoreditems'] = 'Максимальна кількість елементів вмісту в сховищі сеансу вебоглядача';
$string['jsmaxstoreditems_desc'] = 'Коли користувачі переглядають екран основних плиток, браузер зберігатиме HTML для самого екрана огляду плиток і вміст кожної плитки, до максимальної кількості вибраних тут елементів. Це дає змогу отримати дуже швидку реакцію при натисканні нової плитки. Встановлення занадто високого рівня може призвести до повної заповнення сховища веб-переглядача (хоча в тестуванні це не було проблемою)';
...
$string['jsstoredcontentdeletemins'] = 'Збережений вміст сеансу видаляти після (хвилин)';
$string['jsstoredcontentdeletemins_desc'] = 'Після кожного натискання на плитку для того, щоб звільнити простір для поточного HTML-коду, переглядач користувача запустить очищення та <em> видалить </em> зі сховища сеансу весь збережений вміст старше цього (на тій підставі, що він більше не буде надійний, і що все одно буде потрібна нова копія з сервера)';
$string['jsstoredcontentexpirysecs'] = 'Збережений вміст сеансу застаріватиме після (секунд)';
$string['jsstoredcontentexpirysecs_desc'] = 'Коли користувач натискає плитку, якщо вміст плитки у сховищі сеансів веб-переглядача старше, він буде показуватися, але фоновий запит буде зроблено на сервер для нової копії, щоб замінити його. Це дає можливість для подальших оновлень курсу після збереження копією браузера. Якщо збережений вміст молодший за це, вважається, що він є актуальним і показуватиметься, без запиту до сервера';
$string['labelconverted'] = 'Конвертована мітка';
