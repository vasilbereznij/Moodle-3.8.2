...
/**
 * Strings for component 'error', language 'uk', version '3.8'.
 *
 * @package     error
 * @category    string
...
$string['cannotdisableformat'] = 'Ви не можете відключити типовий формат';
...
$string['cannotopenzip'] = 'Не вдалося відкрити zip-файл, можливо помилка zip-розширення на 64-бітних ОС';
...
$string['cannotservefile'] = 'Не можу зберегти файл - проблеми з налаштуванням сервера.';
...
$string['csvfewcolumns'] = 'Недостатньо колонок, перевірте розділювачі.';
...
$string['detectedbrokenplugin'] = 'Модуль "{$a}" неправильний або застарілий, продовження неможливе.';
...
$string['listcantmovedown'] = 'Помилка переміщення елементу нижче, це вже останній елемент.';
...
$string['listcantmoveup'] = 'Помилка переміщення елементу вище, це вже перший елемент.';
...
$string['nopermissiontodelentry'] = 'Ви не можете видаляти записи інших!';
...
$string['nopermissiontoviewgrades'] = 'Не можете переглядати оцінки.';
...
$string['pagenotexist'] = 'Виникла нетипова помилка (спроба дістатися до сторінки, якої не існує)';
...
$string['reverseproxyabused'] = 'Реверсний проксі відключений, сервер не підтримує доступ напряму.<br /> Будь ласка, зверніться до адміністратора серверу.';
...
$string['storedfilecannotcreatefile'] = 'Не вдається створити файл локального пула файлів, будь ласка, перевірте дозволи в каталозі даних moodle та наявність вільного місця на диску.';
$string['storedfilecannotcreatefiledirs'] = 'Не можливо створити локальний файл в каталогах, будь ласка, перевірте права на головний каталог даних.';
...
$string['storedfilenotcreated'] = 'Не створюється файл "{$a->contextid}/{$a->component}/{$a->filearea}/{$a->itemid}/{$a->filepath}/{$a->filename}"';
...
$string['unknownjsinrequirejs'] = 'Не знаходиться JS бібліотека: {$a}';
...
$string['useradminodelete'] = 'Обліковий запис адміністратора не можна видаляти';
...
$string['usernotdeletedadmin'] = 'Користувача не видалено - не можна видаляти обліковий запис адміністратора';
