...
/**
 * Strings for component 'group', language 'uk', version '3.8'.
 *
 * @package     group
 * @category    string
...
$string['importgroups_help'] = 'Групи можуть бути імпортовані з текстового файлу. Формат файлу повинен відповідати таким вимогам:

* Кожен рядок файлу відповідає одному запису
* В кожному записі елементи розділяються комами
* Перший запис містить список імен полів, які визначають формат іншої частини файлу
* Обов’язкове ім’я поля groupname
* Додатково можуть бути поля description, enrolmentkey, picture, hidepicture';
