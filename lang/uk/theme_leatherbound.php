...
/**
 * Strings for component 'theme_leatherbound', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення Leatherbound</h2>
<img src="leatherbound/pix/screenshot.png" />
...
<p>Leatherbound - це проста тема для Moodle 2.0 з трьома колонками змінної ширини створена Патріком Моллі (Patrick Malley).</p>
