...
/**
 * Strings for component 'completion', language 'uk', version '3.8'.
 *
 * @package     completion
 * @category    string
...
$string['completion_help'] = 'Якщо включено, то позначення виконання діяльності відбувається вручну або автоматично ґрунтуючись на певних умовах. За бажанням можна встановити кілька умов. Якщо так, діяльність буде вважатися виконаною, тільки якщо виконані всі умови.

Галочка поряд з назвою діяльності вказує, що вона виконана.';
...
$string['completionexpected_help'] = 'Цей параметр визначає дату, коли діяльність як очікується, буде виконана. Дата не показується студентам і відображається лише в звіті.';
...
$string['completionusegrade_help'] = 'Якщо включено, то діяльність вважається виконаною, якщо студент отримує оцінку. Значення успішного виконання буде відображатися, якщо задано прохідний бал.';
...
$string['err_noactivities'] = 'нформація про виконання не включена в жодній діяльності, тому ніяк не відображається. Ви можете включити інформацію про виконання в налаштуваннях діяльності.';
$string['err_nocourses'] = 'нформація про виконання не включена для інших курсів, тому ніяк не відображається. Ви можете включити інформацію про виконання в налаштуваннях діяльності.';
...
$string['err_settingslocked'] = 'Один або кілька студентів вже виконали необхідні вимоги, тому налаштування було заблоковано. Розблокування критерію виконання видалить дані цих користувачів та може призвести до плутанини на курсі.';
...
$string['unit'] = 'Модуль';
$string['unlockcompletion'] = 'Розблокувати налаштування  виконання';
$string['unlockcompletiondelete'] = 'Розблокувати налаштування виконання та видалити дані про виконання користувачем';
