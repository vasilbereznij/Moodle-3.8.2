...
/**
 * Strings for component 'plugin', language 'uk', version '3.8'.
 *
 * @package     plugin
 * @category    string
...
$string['notdownloadable_help'] = 'ZIP-пакет з оновленнями не вдається завантажити автоматично. Будь ласка, зверніться до документації, щоб отримати детальнішу допомогу.';
