...
/**
 * Strings for component 'url', language 'uk', version '3.8'.
 *
 * @package     url
 * @category    string
...
$string['clicktoopen'] = 'Клацніть посилання {$a} щоб відкрити ресурс.';
...
$string['configrolesinparams'] = 'Включити, якщо ви хочете включити локалізовані імена ролей у список доступних параметрів змінних.';
...
$string['parametersheader_help'] = 'Деякі внутрішні змінні Moodle можуть бути автоматично додані до URL-адреси. Введіть свої назви параметрів у текстові поля і потім виберіть відповідні змінні. Їх значення будуть додані до параметрів у форматі: url-адреса?назва1=значення1&назва2=значення2&... (наприклад, http://good.site.com?name=Сергій&email=sergiy@gmail.com&course=Інформатика)';
...
$string['rolesinparams'] = 'Включити назву ролі в параметри';
