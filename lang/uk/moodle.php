...
/**
 * Strings for component 'moodle', language 'uk', version '3.8'.
 *
 * @package     moodle
 * @category    string
...
$string['addedrecip'] = 'Додано {$a} нового отримувача';
$string['addedrecips'] = 'Додано {$a} нових отримувачів';
...
$string['addfilehere'] = 'Додати файл (и) тут';
...
$string['adminhelpsitesettings'] = 'Визначте як виглядатиме головна сторінка сайту';
...
$string['backtoparticipants'] = 'Повернутися до списку учасників';
...
$string['coursemessage'] = 'Повідомлення користувачам курсу';
...
$string['currentlyselectedusers'] = 'Виділені користувачі';
...
$string['defaulthomepageuser'] = 'Головна сторінка';
$string['defaulthomepageuser_help'] = 'Ваша головна сторінка є першим посиланням у навігації.';
...
$string['emaildisplay'] = 'Показувати ел.пошту';
$string['emaildisplay_help'] = 'Привілейовані користувачі (наприклад, вчителі та менеджери) завжди зможуть бачити вашу адресу електронної пошти.';
$string['emaildisplaycourse'] = 'Тільки іншим слухачам курсу';
$string['emaildisplayhidden'] = 'Сховати ел.пошту';
$string['emaildisplayno'] = 'Сховати мою електронну адресу від непідтвердженних користувачів';
$string['emaildisplayyes'] = 'Показувати всім';
...
$string['emailpasswordconfirmmaybesent'] = '<p>Якщо ви надали правильне ім’я користувача або адресу електронної пошти, вам буде відправлено повідомлення електронної пошти.</p> <p>Воно містить прості інструкції підтвердження і завершення зміни цього пароля. Якщо у вас з цим виникли труднощі, зв\'яжіться з адміністратором сайту.</p>';
...
$string['emailresetconfirmation'] = 'Вітаємо, {$a->firstname},

Було запрошено відновлення пароля для вашого облікового запису \'{$a->username}\' на сайті ’{$a->sitename}’.

Щоб підтвердити цей запит, і встановити новий пароль для вашого облікового запису, перейдіть за наступного адресою в Інтернеті:

{$a->link}
(Це посилання буде дійсне протягом {$a->resetminutes}хв. з моменту запиту відновлення пароля).

Якщо ви не збиралися відновлювати пароль, просто не реагуйте на цей лист.

Якщо вам потрібна допомога, будь ласка, зв\'яжіться з адміністрацією сайту,
{$a->admin}';
...
$string['emojicategorysmileyspeople'] = 'Смайли та люди';
...
$string['enddate_help'] = 'Дату закінчення курсу використовують для визначення того, чи слід включати курс до списку курсів користувачів. Коли дата закінчення минула, курс більше не відображається у навігації та відображається як попередній у огляді курсу. Дату закінчення курсу також можуть використовувати спеціальні звіти. Користувачі можуть вводити курс після дати закінчення; інакше кажучи, дата не обмежує доступ.';
...
$string['frontpagedescription'] = 'Підсумок на першій сторінці';
$string['frontpagedescriptionhelp'] = 'Цей опис сайту буде показано на першій сторінці сайту в блоці Опис курсу/сайту або у верхній секції на Головній сторінці.';
...
$string['frontpagesettings'] = 'Головна сторінка';
...
$string['hiddensections_help'] = 'Цей параметр визначає, чи будуть приховані розділи відображатися для студентів у згорнутому вигляді (можливо, у щотижневому форматі курсу, щоб бачити вихідні та свята) чи повністю невидимому.';
$string['hiddensectionscollapsed'] = 'Приховані розділи показувати в згорнутому виді';
...
$string['hideoncoursepage'] = 'Зробіть доступним, але не відображати на сторінці курсу';
...
$string['invalidlogin'] = 'Ви не пройшли ідентифікацію (неправильне ім’я користувача або пароль).<br />Спробуйте ще раз.';
...
$string['loginguest'] = 'Увійдіть як гість';
...
$string['messagedselectedcountusersfailed'] = 'Виникла проблема і {$a} повідомлення не були надіслані.';
$string['messagedselecteduserfailed'] = 'Повідомлення не було надіслано до користувача {$a->fullname}.';
...
$string['missinglastname'] = 'Не вказано прізвище';
...
$string['modvisible_help'] = 'Якщо для доступності встановлено значення «Показати на сторінці курсу», діяльність або ресурс доступні для студентів (з урахуванням будь-яких обмежень доступу, які можуть бути встановлені).

Якщо для доступності встановлено значення «Сховати від учнів», активність або ресурс доступні лише користувачам із дозволом переглядати приховані дії (за замовчуванням користувачі з роллю вчителя або вчителя без редагування).';
$string['modvisiblehiddensection'] = 'Доступність';
$string['modvisiblehiddensection_help'] = 'Якщо для доступності встановлено значення «Сховати від учнів», активність або ресурс доступні лише користувачам із дозволом переглядати приховані дії (за замовчуванням користувачі з роллю вчителя або вчителя без редагування).

Якщо курс містить багато заходів або ресурсів, сторінку курсу можна спростити, встановивши для доступності значення «Зробити доступним, але не відображатися на сторінці курсу». У цьому випадку посилання на дію чи ресурс має бути надано з іншого місця, наприклад із ресурсу сторінки. Діяльність все одно буде зазначена в журналі оцінок та інших звітах.';
$string['modvisiblewithstealth'] = 'Доступність';
$string['modvisiblewithstealth_help'] = 'Якщо для доступності встановлено значення «Показати на сторінці курсу», діяльність або ресурс доступні для студентів (з урахуванням будь-яких обмежень доступу, які можуть бути встановлені).
...
$string['movecoursemodule'] = 'Перемістити ресурс';
...
$string['participantscount'] = 'Кількість учасників: {$a}';
...
$string['previewhtml'] = 'Попередній перегляд у форматі HTML';
...
$string['restoretositeadding'] = 'Попередження: Ви збираєтеся відновити Головну стрінку сайту, додаванням до неї даних з резервної копії!';
$string['restoretositedeleting'] = 'Попередження: Ви збираєтеся відновити Головну стрінку сайту, видаливши з неї всю поточну інформацію!';
...
$string['showgrades_help'] = 'Багато діяльностей в курсі дозволяють оцінення. Цей параметр визначає, чи матиме можливість студент бачити список всіх своїх оцінок за курс у власному журналі оцінок (через посилання в блоці Керування)';
...
$string['sitemessage'] = 'Повідомлення користувачів';
...
$string['userfilterplaceholder'] = 'Шукати по ключових словах або вибрати фільтр';
$string['userlist'] = 'Список користувачів';
$string['usermenu'] = 'Меню користувача';
$string['username'] = 'Ім’я входу';
$string['usernameemail'] = 'Ім’я входу / ел.пошта';
