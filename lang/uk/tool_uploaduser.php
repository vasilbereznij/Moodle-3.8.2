...
/**
 * Strings for component 'tool_uploaduser', language 'uk', version '3.8'.
 *
...
$string['csvdelimiter'] = 'Розділювач CSV';
...
$string['uploadusers_help'] = 'Користувачі можуть бути завантажені (та додатково записані на курси) з текстового файлу. Формат файлу повинен відповідати таким вимогам:
* Кожен рядок файлу означає один запис
* В кожному записі розділення даних проводиться за допомогою коми (або іншого символу)
* Перший запис містить список імен полів, які визначають формат іншої частини файлу
* Обов’язковими є поля username, password, firstname, lastname, email';
