...
/**
 * Strings for component 'quizaccess_seb', language 'uk', version '3.8'.
 *
...
$string['disabledsettings_help'] = 'Налаштування вікторини Safe Exam Browser не можна змінити, якщо тест було виконано. Щоб змінити налаштування, спочатку потрібно видалити всі спроби тесту.';
...
$string['event:accessprevented'] = 'Доступ до вікторини був заблокований';
...
$string['invalidkeys'] = 'Не вдалося перевірити ключ конфігурації або ключі іспиту веб-переглядача. Переконайтеся, що ви використовуєте браузер Safe Exam Browser з правильним файлом конфігурації.';
...
$string['noconfigfound'] = 'Не вдалося знайти конфігурацію SEB для вікторини з cmid: {$a}';
$string['not_seb'] = 'Безпечний Екзаменаційний Браузер не використовується';
$string['notemplate'] = 'Без шаблону';
$string['passwordnotset'] = 'Поточні налаштування вимагають, щоб тести використовували браузер Safe Exam Browser, щоб встановити пароль вікторини.';
$string['pluginname'] = 'Правила доступу до Безпечного Екзаменаційного Браузера';
$string['privacy:metadata:quizaccess_seb_quizsettings'] = 'Налаштування браузера Safe Exam Browser для вікторини. Сюди входить ідентифікатор останнього користувача, який створив або змінив налаштування.';
$string['privacy:metadata:quizaccess_seb_quizsettings:quizid'] = 'Ідентифікатор вікторини, для якої існують налаштування.';
...
$string['quizsettings'] = 'Налаштування вікторини';
...
$string['seb_allowedbrowserexamkeys_help'] = 'У цьому полі ви можете ввести дозволені ключі іспиту веб-переглядача для версій Safe Exam Browser, яким дозволено доступ до цієї вікторини. Якщо ключі не введені, ключі іспиту в браузері не перевіряються.';
...
$string['seb_help'] = 'Налаштуйте вікторину для використання браузера Safe Exam Browser.';
...
$string['seb_showsebdownloadlink_help'] = 'Якщо ввімкнено, кнопка для завантаження браузера Safe Exam Browser відображатиметься на початковій сторінці вікторини.';
...
$string['setting:autoreconfigureseb_desc'] = 'Якщо ввімкнено, користувачі, які переходять до вікторини за допомогою браузера Safe Exam Browser, будуть автоматично змушені переналаштувати свій браузер Safe Exam Browser.';
$string['setting:displayblocksbeforestart'] = 'Покажіть блоки перед початком вікторини';
...
$string['setting:displayblockswhenfinished'] = 'Відобразити блоки після завершення вікторини';
...
$string['setting:showseblinks_desc'] = 'Чи показувати посилання для користувача для доступу до файлу конфігурації браузера Safe Exam Browser, коли доступ до вікторини заборонений. Зауважте, що посилання seb:// можуть працювати не в кожному браузері.';
