...
/**
 * Strings for component 'tool_uploadcourse', language 'uk', version '3.8'.
 *
...
$string['cannotupdatefrontpage'] = 'Забороняється змінювати головну сторінку';
...
$string['csvdelimiter_help'] = 'Символ роздільник полів у CSV файлі.';
$string['csvfileerror'] = 'Щось не так з форматом CSV файлу. Будь ласка, перевірте чи відповідна кількість колонок та що роздільник і кодування файлу вказані правильно: {$a}';
...
$string['uploadcourses_help'] = 'Курси можуть бути завантаженими з текстового файлу. Формат файлу повинен бути таким:

* кожен рядок файлу - це один запис
* кожен запис - це набір даних розділених комами (або інший роздільник)
* перший запис - це список назв полів, що визначає формат іншої частини файлу
* обов’язковими полями є shortname, fullname, та category';
