...
/**
 * Strings for component 'theme_boxxie', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення Boxxie</h2>
<img src="boxxie/pix/screenshot.png" />
...
<p>Boxxie - це проста тема для Moodle 2.0 з трьома колонками змінної ширини.</p>
