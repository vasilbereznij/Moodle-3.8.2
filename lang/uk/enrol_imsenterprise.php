...
/**
 * Strings for component 'enrol_imsenterprise', language 'uk', version '3.8'.
 *
...
$string['allowunenrol'] = 'Дозволити IMS даним <strong>відраховувати</strong> з курсу студентів/викладачів';
...
$string['categoryidnumber'] = 'Дозволити номер категорії';
$string['categoryidnumber_desc'] = 'Якщо ввімкнено, IMS Enterprise створить категорію з idnumber';
$string['categoryseparator'] = 'Символ роздільника категорій';
$string['categoryseparator_desc'] = 'Обов’язковий, якщо ввімкнено «Ідентифікатор категорії». Символ для розділення назви категорії та ідентифікаційного номера.';
...
$string['createnewusers_desc'] = 'Дані IMS Enterprise зарахування описують налаштування користувачів. Якщо включено, то облікові записи можуть створюватися для користувачів, яких немає в базі Moodle. Користувачі відшуковуються спочатку по "idnumber", а потім по псевдоімені (username). Пароль модулем зарахування не імпортується. Використання модуля перевірки автентичності рекомендується для аутентифікації користувачів.';
