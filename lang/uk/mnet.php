...
/**
 * Strings for component 'mnet', language 'uk', version '3.8'.
 *
 * @package     mnet
 * @category    string
...
$string['hostexists'] = 'Запис для хоста з таким іменем вже існує (можливо потрібно видалити). <a href="{$a}">Клацніть тут</a> для редагування цього запису.';
