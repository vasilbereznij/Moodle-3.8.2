...
/**
 * Strings for component 'backup', language 'uk', version '3.8'.
 *
 * @package     backup
 * @category    string
...
$string['asyncmessagebodydefault'] = 'Вітаємо, {user_firstname}! Ваша {операція} (ідентифікатор: {backupid}) успішно завершена. <br/><br/>Ви можете отримати доступ до нього тут: {link}.';
