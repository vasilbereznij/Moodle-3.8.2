...
/**
 * Strings for component 'block', language 'uk', version '3.8'.
 *
 * @package     block
 * @category    string
...
$string['addtodock'] = 'Перемістити на панель';
...
$string['createdat_help'] = 'Оригінальне розташування блоку - це місце де блок було створено. В налаштуванні блоку можна вказати, що блок повинен з’являтися в інших місцях (контекстах) у вихідному розташуванні. Наприклад, блок створений на сторінці курсу може бути відображеним у діяльностях в рамках цього курсу. Блоки, створені на головній сторінці можуть відображатися на всьому сайті.';
...
$string['deleteblockcheck'] = 'Ви справді хочете видалити блок  {$a}?';
...
$string['dockblock'] = 'Прикріпити до панелі блок {$a}';
$string['hideblock'] = 'Приховати блок {$a}';
$string['hidedockpanel'] = 'Приховати на панель';
...
$string['showonfrontpageandsubs'] = 'Показувати на Головній сторінці та сторінках, які входять у Головну сторінку';
$string['showonfrontpageonly'] = 'Показувати тільки на Головній сторінці';
$string['subpages'] = 'Конкретні суб-сторінки';
$string['thisspecificpage'] = 'Ця конкретна сторінка (сторінка {$a})';
$string['undockall'] = 'Відкріпити все';
$string['undockblock'] = 'Відкріпити від панелі блок {$a}';
$string['undockitem'] = 'Відкріпити цей блок';
