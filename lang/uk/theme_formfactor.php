...
/**
 * Strings for component 'theme_formfactor', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення FormFactor</h2>
<img src="formfactor/pix/screenshot.png" />
...
<p>FormFactor - це проста тема для Moodle 2.0 з трьома колонками змінної ширини створена Патріком Моллі (Patrick Malley).</p>
