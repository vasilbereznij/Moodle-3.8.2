...
/**
 * Strings for component 'auth', language 'uk', version '3.8'.
 *
 * @package     auth
 * @category    string
...
$string['auth_fieldlock_expl'] = '<p> <b> Закрите значення: </b> Якщо включити, то заборонятиме користувачам і адміністрації редагування безпосередньо поля. Використовуйте цю функцію, якщо Ви зберігаєте ці дані в зовнішній системі. </p>';
...
$string['errorminpasswordnonalphanum'] = 'Паролі повинні мати не менше {$a} не алфавітно-цифрових символів, таких як *, - або #.';
...
$string['informminpasswordnonalphanum'] = 'щонайменше {$a} не алфавітно-цифрових символів, наприклад *, - або #';
