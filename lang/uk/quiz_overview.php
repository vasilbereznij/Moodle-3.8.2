...
/**
 * Strings for component 'quiz_overview', language 'uk', version '3.8'.
 *
...
$string['regradecomplete'] = 'Переоцінка успішно завершена';
$string['regradedsuccessfullyxofy'] = 'Успішно оновлено ({$a->done}/{$a->count})';
