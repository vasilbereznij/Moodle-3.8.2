...
/**
 * Strings for component 'assign', language 'uk', version '3.8'.
 *
 * @package     assign
 * @category    string
...
$string['assign:viewblinddetails'] = 'Бачити ідентифікацію студентів при включеному безособовому оцінюванні';
...
$string['attemptreopenmethod'] = 'Можливість перездачі';
$string['attemptreopenmethod_help'] = 'Визначає, як студент буде отримувати можливість нових спроб. Можливі опції: <ul><li>Ніколи - Перездача робіт не дозволяється.</li><li>Вручну - Викладач відкриває для студента нову спробу.</li><li>Автоматично до виконання - Студенту автоматично будуть надаватися нові спроби доки він не отримає мінімально необхідну оцінку для цього завдання визначену в журналі оцінок (в секції Категорії та елементи).</li></ul>';
...
$string['blindmarking'] = 'Безособове оцінювання';
$string['blindmarking_help'] = 'Безособове оцінювання буде приховувати ідентифікацію студентів під час оцінювання. Безособове оцінювання буде закривати результати здачі та оцінку у відношенні завдання.';
$string['blindmarkingenabledwarning'] = 'Для цієї діяльності використовується безособове оцінювання.';
...
$string['completionsubmit'] = 'Студент повинен відправити роботу';
...
$string['duedateno'] = 'Термін здачі не обмежено';
...
$string['introattachments_help'] = 'Додаткові файли для використання у завданні, наприклад, шаблони відповідей. Завантажені файли будуть показуватися на сторінці завдання після опису.';
...
$string['mysubmission'] = 'Мої роботи:';
...
$string['nolatesubmissions'] = 'Немає прострочених завдань';
...
$string['nosubmissionsacceptedafter'] = 'Немає завдань зданих після';
...
$string['notsubmittedyet'] = 'Ще без відповіді';
...
$string['overdue'] = '<font color="red">Термін здачі прострочено на: {$a}</font>';
...
$string['reopenuntilpassincompatiblewithblindmarking'] = 'Автоматичний режим не сумісний з безособовим оцінюванням, бо оцінки не публікуються в Журналі оцінок доки не будуть розкриті особи студентів.';
...
$string['reverttodraft'] = 'Повернути в стан чернетки.';
...
$string['sendstudentnotifications'] = 'Повідомити студентів';
$string['sendstudentnotifications_help'] = 'Встановіть типове значення для функції "Повідомити студентів" у формі оцінювання.';
$string['sendstudentnotificationsdefault'] = 'Якщо включено, то студентам буде надіслано повідомлення про оновлення їхньої оцінки або відгуку.';
$string['sendstudentnotificationsdefault_help'] = 'Типове для "Повідомити студентів"';
...
$string['submissionsnotgraded'] = 'Не оцінено робіт: {$a}';
