...
/**
 * Strings for component 'theme_arialist', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення Arialist</h2>
...
<p>Arialist - це проста тема для Moodle 2.0 з двома колонками змінної ширини.</p>
...
$string['logo'] = 'Логотип';
$string['logodesc'] = 'Додайте URL-адресу нового логотипу, якщо ви хочете замінити стандартний логотип цієї теми. Повинен мати вигляд типу http://www.yoursite.com/path/to/logo.png';
...
$string['regionwidthdesc'] = 'Цей параметр задає ширину лівої та правої колонок для блоків.';
$string['tagline'] = 'Гасло';
$string['taglinedesc'] = 'Коротке гасло, яке буде виводитися під назвою сайту на головній сторінці.<br /><em>(Не показується з логотипом)</em>';
