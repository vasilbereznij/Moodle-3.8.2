...
/**
 * Strings for component 'enrol', language 'uk', version '3.8'.
 *
 * @package     enrol
 * @category    string
...
$string['eventuserenrolmentupdated'] = 'Критерії зарахування користувача оновлено';
...
$string['none'] = 'Нічого';
$string['notenrollable'] = 'Ви не можете самостійно зареєструватися на цей курс. Метод самореєстрації або відсутній, або заборонений, або дозволений на інший період часу. Звертайтесь до викладача.';
...
$string['unenrolnotpermitted'] = 'Ви не маєте відповідних прав або ж цього користувача не можна відрахувати з цього курсу.';
