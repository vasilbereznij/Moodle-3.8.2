...
/**
 * Strings for component 'tool_xmldb', language 'uk', version '3.8'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['nomissingindexesfound'] = 'Не знайдено відсутніх індексів, ваша база даних не потребує подальших дій.';
