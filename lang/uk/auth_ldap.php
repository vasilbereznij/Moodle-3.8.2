...
/**
 * Strings for component 'auth_ldap', language 'uk', version '3.8'.
 *
 * @package     auth_ldap
 * @category    string
...
$string['auth_ldap_noextension'] = '<em>Модуль PHP LDAP не знайдено. Будь ласка, впевніться, що він встановлений та дозволений до використання.</em>';
