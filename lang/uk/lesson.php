...
/**
 * Strings for component 'lesson', language 'uk', version '3.8'.
 *
 * @package     lesson
 * @category    string
...
$string['additionalattemptsremaining'] = 'Виконано. Ви можете використати ще одну спробу в цьому уроці.';
...
$string['emailallgradedessays'] = 'Відіслати ВСІ оцінені есе';
$string['emailgradedessays'] = 'Відіслати оцінені есе';
$string['emailsuccess'] = 'Електронні листи успішно надіслані';
...
$string['lessoncloseson'] = 'Закриття уроку на {$a}';
$string['lessoneventcloses'] = '{$a} закривається';
$string['lessoneventopens'] = '{$a} доступних';
$string['lessonformating'] = 'Форматування уроку';
$string['lessonmenu'] = 'Меню уроку';
$string['lessonname'] = 'Урок: {$a}';
