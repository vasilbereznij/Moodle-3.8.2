...
/**
 * Strings for component 'enrol_ldap', language 'uk', version '3.8'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['phpldap_noextension'] = '<em>Здається, відсутній модуль PHP LDAP. Будь ласка, переконайтеся, що його встановлено та включено. Інакше використання цього модуля не можливе.</em>';
