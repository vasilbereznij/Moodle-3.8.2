...
/**
 * Strings for component 'quiz', language 'uk', version '3.8'.
 *
 * @package     quiz
 * @category    string
...
$string['configdecimalplacesquestion'] = 'Кількість знаків після коми, які мають бути показаними під час висвічування на екрані оцінки за кожне запитання.';
...
$string['confirmclose'] = 'Ви вибрали закінчення тесту (даної спроби). Якщо ви це підтверджуєте, Ви більше не зможете змінювати ваші відповіді.';
...
$string['decimalplacesquestion'] = 'Кількість десяткових знаків у оцінці за питання';
$string['decimalplacesquestion_help'] = 'Це налаштування визначає кількість десяткових знаків, які будуть відображатися при показу оцінок за кожне питання.';
...
$string['messageprovider:submission'] = 'Повідомлення про проходження тесту';
$string['min'] = 'Мін';
...
$string['numattemptsmade'] = '{$a} спроб проходження цього тесту';
$string['numberabbr'] = '№';
...
$string['quiz:emailconfirmsubmission'] = 'Отримувати поштове підтвердження проходження';
$string['quiz:emailnotifysubmission'] = 'Отримувати поштове повідомлення результатів';
$string['quiz:emailwarnoverdue'] = 'Отримувати повідомлення коли час спроби спливає і результати повинні бути відправлені.';
...
$string['quiz:manageoverrides'] = 'Керувати перевизначенням тестів';
...
$string['quizeventcloses'] = '{$a} закривається';
$string['quizeventopens'] = '{$a} доступних';
...
$string['quizopenedon'] = 'Тест відкритий з {$a}';
...
$string['reviewofpreview'] = 'Огляд попереднього перегляду';
...
$string['settingsoverrides'] = 'Налаштування перевизначень';
