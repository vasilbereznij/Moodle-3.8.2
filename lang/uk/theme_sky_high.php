...
/**
 * Strings for component 'theme_sky_high', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення Sky High</h2>
<img src="sky_high/pix/screenshot.png" />
...
<p>Sky High - це тема для Moodle з трьома колонками змінної ширини (cnbkm ,kjue). </p>
...
<h2>Розробники</h2>
<p>Дизайнер цієї теми Джуліан Райден (Julian Ridden). Тема спрограмована та підтримується Джоном Стабінгером (John Stabinger) з NewSchool Learning (contact@newschoollearning.com). </p>
...
$string['configtitle'] = 'Тема Sky High';
...
$string['logo'] = 'Логотип';
$string['logodesc'] = 'Додайте URL-адресу нового логотипу, якщо ви хочете замінити стандартний логотип цієї теми. Повинен мати вигляд типу http://www.yoursite.com/path/to/logo.png. Логотип повинен мати 50px у висоту.';
