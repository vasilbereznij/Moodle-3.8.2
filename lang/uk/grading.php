...
/**
 * Strings for component 'grading', language 'uk', version '3.8'.
 *
 * @package     grading
 * @category    string
...
$string['formnotavailable'] = 'Було вибрано для використання розширений метод оцінювання, але форма оцінювання поки недоступна. Вам потрібно її спочатку створити через перше посилання у блоці налаштування.';
