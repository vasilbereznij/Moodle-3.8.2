...
/**
 * Strings for component 'grades', language 'uk', version '3.8'.
 *
 * @package     grades
 * @category    string
...
$string['coursesettingsexplanation'] = 'Визначте, як буде виглядати журнал оцінок для всіх учасників курсу.';
...
$string['importcsv_help'] = 'Оцінки можуть бути імпортовані через CSV файл з форматом такого виду:

* Кожен рядок файлу - це один запис
* Кожен запис вміщує інформацію розділену комами або іншим роздільником
* Перший рядок містить список з назв полів, які визначають формат іншої частини файлу
* Одне з полів повинно мати один з ідентифікаторів користувача - його псевдоім’я або код, або ел.пошту

Щоб отримати правильний формат, спочатку експортуйте кілька оцінок у файл, та перегляньте отриманий CSV файл.';
...
$string['nonunlockableverbose'] = 'Цю оцінку не можна розблокувати, поки не розблокована {$a->itemname}';
...
$string['removeallcoursegrades_help'] = 'Якщо відмічено, то всі елементи оцінок, які були додані в журнал оцінок вручну, будуть вивилучені разом з оцінками і даними, які є перевизначеними, виключеними (не оцінюються), приховувані чи блоковані. Залишаться лише оцінки пов’язані з активними елементами.';
