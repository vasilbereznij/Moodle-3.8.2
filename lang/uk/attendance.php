...
/**
 * Strings for component 'attendance', language 'uk', version '3.8'.
 *
 * @package     attendance
 * @category    string
...
$string['confirmdeleteuser'] = 'Ви впевнені, що хочете видалити користувача «{$ a-> full name}» ({$ a-> email})? <br/> Всі записи про його відвідуваності будуть видалені безповоротно.';
...
$string['studentavailability'] = 'Доступно для студентів (хвилин)';
$string['studentavailability_help'] = 'Коли студенти відзначають свою відвідуваність, цей статус буде доступний протягом заданої кількості хвилин після початку заняття.
<br/> Якщо порожньо, то статус завжди буде доступний, якщо дорівнює 0, то він завжди буде прихований від студентів.';
