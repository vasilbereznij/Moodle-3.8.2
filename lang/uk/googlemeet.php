...
/**
 * Strings for component 'googlemeet', language 'uk', version '3.8'.
 *
 * @package     googlemeet
 * @category    string
...
$string['clientid_desc'] = '<a href="https://github.com/ronefel/moodle-mod_googlemeet/wiki/How-to-create-the-API-key-and-OAuth-client-ID" target="_blank">Як створити API key та OAuth client ID</a>';
$string['date'] = 'Дата';
...
$string['from'] = 'з';
$string['generateurlroom'] = 'Сгенерувати посилання для зустрічі';
...
$string['name'] = 'Назва';
$string['never'] = 'Ніколи';
$string['notfoundrecordingname'] = 'Не знайдено записів з назвою';
$string['notfoundrecordingsfolder'] = 'На Google Drive не знайдено каталог "Meet Recordings".';
...
$string['notpossiblesync'] = 'Не можливо виконати синхронізацію с обліковим записом відмінним від того в якому було створено зустріч';
$string['or'] = 'або';
...
$string['requirednamefield'] = 'Задайте назву зустрічі для автоматичного створення.';
