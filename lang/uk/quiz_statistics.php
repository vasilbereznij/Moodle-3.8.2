...
/**
 * Strings for component 'quiz_statistics', language 'uk', version '3.8'.
 *
...
$string['quizstatisticscleanuptask'] = 'Очистіть старі записи кешу статистики тестів';
...
$string['statistics:componentname'] = 'Статистичний звіт тесту';
