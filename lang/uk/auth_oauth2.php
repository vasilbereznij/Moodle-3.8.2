...
/**
 * Strings for component 'auth_oauth2', language 'uk', version '3.8'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['noissuersavailable'] = 'Жодна з налаштованих служб OAuth2 не дозволяє пов’язувати облікові записи для входу';
