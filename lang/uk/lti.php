...
/**
 * Strings for component 'lti', language 'uk', version '3.8'.
 *
 * @package     lti
 * @category    string
...
$string['global_tool_types'] = 'Загальні типи засобів';
...
$string['modulenamepluralformatted'] = 'Екземпляри ЗНВ';
$string['name'] = 'Назва';
$string['never'] = 'Ніколи';
...
$string['organizationid'] = 'ID організації';
$string['organizationid_help'] = 'Унікальний ідентифікатор для цього екземпляра Moodle. Як правило, використовується ім’я DNS організації.

Якщо це поле залишити порожнім, ім’я хоста цього сайту Moodle використовуватиметься як значення за замовчуванням.';
