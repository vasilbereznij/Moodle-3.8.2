...
/**
 * Strings for component 'forum', language 'uk', version '3.8'.
 *
 * @package     forum
 * @category    string
...
$string['cannotviewpostyet'] = 'Ви поки що не можете читати відповіді інших студентів в цій дискусії, бо ви не самі нічого не відповіли.';
...
$string['configlongpost'] = 'Повідомлення, що перевищують цей розмір (без тегів HTML), вважати довгими. Повідомлення, які показуються на першій сторінці сайту, сторінках курсів у форматі форуму, або в профілях користувачів будуть обмежені за розміром значення forum_shortpost і forum_longpost.';
...
$string['discussionnowsubscribed'] = '{$a->name} буде отримувати сповіщення про нові повідомлення дискусії \'{$a->discussion}\' з форуму \'{$a->forum}\'';
...
$string['forumbodyhidden'] = 'Це повідомлення не може бути вами переглянуто, можливо тому, що ви самі ще нічого не надіслали до цієї дискусії.';
...
$string['forumtype_help'] = 'Існує 5 типів форумів:

* Проста одиночна дискусія - проста дискусійна гілка, на яку кожен може відповісти
* Кожен публікує одну дискусію - Кожен студент може почати тільки одну дискусію, всі можуть на них відповідати
* Форум питання-відповідь - Студенти повинні спочатку надіслати свою відповідь, перед тим як бачити відповіді інших
* Стандартний форум у форматі блогу - Відкритий форум, де кожен може почати нову дискусію будь-коли, і всі відповіді відображаються на одній сторінці
* Стандартний форум для загального використання - Відкритий форум, де кожен може в будь-який час почати нову тему та відповідати';
...
$string['overviewnumpostssince'] = '{$a} повідомлень починаючи з останнього входу';
$string['overviewnumunread'] = '{$a} всього не прочитано';
...
$string['privatereply_help'] = 'Приватну відповідь може переглядати лише автор публікації, на яку відповідає, і всі користувачі, які мають можливість переглядати приватні відповіді.';
...
$string['qandanotify'] = 'Це Форум питань та відповідей. Щоб бачити інші відповіді на питання, вам потрібно спочатку самому дати відповідь.';
$string['re'] = 'Re:';
...
$string['searchsubject'] = 'Ці слова повінні бути в назві теми (у заголовку) повідомлення';
...
$string['subject'] = 'Тема';
$string['subscribe'] = 'Підписатися на цей форум';
...
$string['trackingtype_help'] = 'Якщо включено, то учасники можуть відстежувати повідомлення у форумі та дискусії як прочитані та непрочитані. Є три опції:

* Не обов\'язково - Учасники можуть вибрати, чи слід включити відстеження чи вимкнути
* Увімкнути - Відстеження обов’язково увімкнуте
* Вимкнути - Відстеження обов’язково вимкнуте';
