...
/**
 * Strings for component 'admin', language 'uk', version '3.8'.
 *
 * @package     admin
 * @category    string
...
$string['agedigitalconsentverification_desc'] = 'Вмикає перевірку віку згоди перед відображенням сторінки реєстрації для користувачів з самостійною реєстрацією. Це захистить ваш сайт від неповнолітніх, які підписуються без згоди батьків / опікунів. <a target="_blank" href="{$a}">Контактну інформацію про підтримку</a> надано неповнолітнім для отримання додаткової допомоги.';
...
$string['allowattachments'] = 'Дозволити долучення';
...
$string['allowblockstodock'] = 'Дозволити блокам використовувати панель';
...
$string['allowindexing_desc'] = 'Це визначає, чи дозволити пошуковим системам індексувати ваш сайт. "Скрізь" дозволить пошуковим системам здійснювати пошук у всьому світі, включаючи сторінки входу та реєстрації, що означає, що сайти з увімкненим Force Login все ще проіндексовані. Щоб уникнути ризику спаму, пов\'язаного з можливістю пошуку на сторінці реєстрації, використовуйте "Скрізь, окрім сторінок реєстрації". "Ніде" не дасть пошуковим системам не індексувати будь-яку сторінку. Зверніть увагу, що це лише тег у заголовку сайту. Пошукова система повинна поважати тег.';
...
$string['autologinguests'] = 'Автоматичний вхід гостем';
$string['availablelicenses'] = 'Доступні ліцензії';
...
$string['blockinstances'] = 'Приклади';
...
$string['configallowassign'] = 'Дозволити ролі, вказаній зліва, призначати користувачів на ролі вказані в колонках';
$string['configallowattachments'] = 'Якщо включено, то листи з сайту можуть містити файлові долучення, наприклад, відзнаки.';
$string['configallowblockstodock'] = 'Якщо дозволено та підтримується вибраною темою, користувачі можуть переміщувати блоки у спеціальну панель.';
...
$string['configallowcoursethemes'] = 'При включеному, курсам буде дозволено мати власні теми.Теми курсів відкидають всі інші теми (сайту, користувача або сесії)';
...
$string['configallowguestmymoodle'] = 'Якщо включено, то гості можуть мати доступ до Інформаційної панелі, інакше вони будуть перенаправлятися на Головну сторінку сайту.';
...
$string['configallowoverride2'] = 'Виберіть, яка роль(і) може бути уточнена ролями в лівій колонці.<br />Зауважте, що ці налаштування тільки для користувачів, які мають права moodle/role:override або moodle/role:safeoverride.';
$string['configallowswitch'] = 'Виберіть, на які ролі користувач може перемикатися, що базується на тому, які ролі вони вже мають. Крім того, користувач повинен мати право на moodle/role:switchroles.<br /> Зауважте, що це дає можливість перемикатисятільки до ролей які мають право moodle/course:view та не мають права moodle/site:doanything, тому деякі колонки в цій таблиці недоступні.';
...
$string['configallowview'] = 'Виберіть, які ролі користувач бачитиме, зможе використовувати в фільтрах і т. д. В залежності від того, які ролі у нього вже є.';
$string['configallusersaresitestudents'] = 'Для дій на головній сторінці сайту, всі користувачі мають розглядатися як студенти? Якщо вибрати "Так", то будь-якому активованому користувачі буде дозволено працювати як студент. Якщо вибрати "Ні", то тільки користувачі, які є учасниками хоча б одного курсу, матимуть можливість брати участь уроботі даної сторінки. Тільки адміністратори та спеціально призначені викладачі можуть діяти як викладачі на головній сторінці.';
...
$string['configcustommenuitems'] = 'Тут можна налаштувати спеціальне меню. Введіть кожен пункт меню на новому рядку з форматом: текст меню, URL-адреса посилання (необов’язково, не для верхнього пункту меню з підпунктами), заголовок підказки (необов’язково) та код мови або список кодів, розділених комами ( необов’язково, для відображення рядка лише для користувачів вказаної мови), розділених символами вертикальної лінії. Рядки, які починаються з дефіса, відображатимуться як пункти меню в попередньому меню верхнього рівня, а ### створює роздільник. Наприклад:
<pre>
курси
-Усі курси|/курс/ -Пошук курсу|/course/search.php
-### -FAQ|https://someurl.xyz/faq
-Preguntas más frecuentes|https://someurl.xyz/pmf||es
Мобільний додаток|https://someurl.xyz/app|Завантажте наш додаток
</pre>';
$string['configcustomusermenuitems'] = 'Ви можете налаштувати вміст меню користувача (за виключенням елементу Вихід, який додається автоматично). Кожен рядок розділяється символом | та містить 1) змінні в формі "langstringname, componentname" як простий текст, 2) URL, та 3) піктограму як pix іконку або як URL. Можна також використати роздільники додавши один або більше символів #.';
...
$string['configdefaulthomepage'] = 'Це визначає домашню сторінку для користувачів, які увійшли';
...
$string['configdocroot'] = 'Визначає шлях до документації Moodle. Ви можете його змінити, якщо маєте власну документацію. Якщо Ви це робите, впевніться, що зв\'язки між файлами документації відповідають формату http://docs.moodle.org.';
$string['configdoctonewwindow'] = 'Якщо це включити, то посилання на документацію Moodle будуть показуватися в новому вікні.';
...
$string['configenablesafebrowserintegration'] = 'Це додає вибір "Потрібен Безпечний Екзаменаційний браузер" до поля "Безпека браузера"у формі налаштування тестування. Для детальнішої інформації перегляньте ресурс http://www.safeexambrowser.org/';
...
$string['configforcelogin'] = 'Зазвичай, доступ до головної сторінки сайту та до списку курсів здійснюється без попередньої реєстрації. Якщо ви бажаєте, щоб всі користувачі мали доступ до всіх ресурсів сайту тільки після реєстрації, виберіть дане встановлення.';
...
$string['configfrontpage'] = 'Вибрані елементи будуть виводитися на головній сторінці сайту.';
$string['configfrontpagecourselimit'] = 'Максимальна кількість курсів';
$string['configfrontpagecourselimithelp'] = 'Максимальна кількість курсів, які будуть показуватися на головній сторінці сайту в списку курсів.';
$string['configfrontpageloggedin'] = 'Вибрані елементи будуть виводитися на головній сторінці сайту для користувачів, які увійшли до системи.';
$string['configfrontpagemanagers'] = 'Вибрані елементи будуть виводитися на головній сторінці сайту для менеджерів.';
$string['configfrontpageteachers'] = 'Вибрані елементи будуть виводитися на головній сторінці сайту для викладачів.';
$string['configfrontpagestudents'] = 'Вибрані елементи будуть виводитися на головній сторінці сайту для студентів.';
$string['configfullnamedisplay'] = 'Оберіть, у якому форматі повне ім\'я користувача буде показуватися на сторінках сайту. Типове значення, "language", залишає його в значенні "fullnamedisplay" для локалізації відповідно до мови інтерфейсу. Деякі мови мають інакші підходи до представлення імені.

Для більшості одномовних сайтів ефективним налаштуванням є "firstname lastname", але ви можете повністю сховати прізвище. При цьому можна використати такі параметри: firstname, lastname, firstnamephonetic, lastnamephonetic, middlename, and alternatename.';
...
$string['configintrosite'] = 'На цій сторінці ви зможете налаштувати вид головної сторінки та дати назву вашому сайту. Ви зможете повернутися на цю сторінку пізніше, використовуючи меню Керування сайтом - "Головна сторінка" - "Вигляд"';
...
$string['confignavshowallcourses'] = 'Цей параметр гарантує, що всі курси на сайті показуються в навігації весь час.';
$string['confignavshowcategories'] = 'Показувати категорії курсів у навігаційному рядку та навігаційних блоках. Це не стосується курсів, де користувач наразі зареєстрований, вони будуть показуватися у списку власних курсів без категорій.';
...
$string['configpasswordpolicy'] = 'Включення цього заставить Moodle перевірити паролі користувачів на відповідність політики ведення паролів. Використайте установки, які подано далі, для специфікації вашої політики (всі вони будуть проігноровані, якщо тут ви виберете \'Ні\').';
...
$string['configprofileroles'] = 'Список ролей, які видимі в профайлі користувача та сторінці учасників.';
...
$string['configrecaptchapublickey'] = 'Рядок символів, які використовуватимуться для показу елементу reCAPTCHA у формі. Згенероване <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
$string['configrequestcategoryselection'] = 'Дозволити вибір категорії при замовленні нового курсу.';
...
$string['configsmtpauthtype'] = 'Це налаштовує тип аутентифікації для використання на smpt сервері.';
...
$string['configsupportemail'] = 'Ця адреса електронної пошти буде показана користувачам цього сайту, як скринька для загальної допомоги (наприклад, коли нові користувачі створюють свої власні облікові записи). Якщо бланк залишити пустим, тоді користувачам нічого не буде показуватися.';
$string['configsupportname'] = 'Це ім\'я персони або іншого об\'єкту, що пропонує загальну довідку через електронну пошту підтримки користувачів або адреса веб-серверу.';
$string['configsupportpage'] = 'Ця адреса веб-сервера буде показана користувачам цього сайту, як сторінка загальної довідки (наприклад, коли нові користувачі створюють свої власні облікові записи). Якщо цей бланк залишити порожнім, тоді нічого показуватися не буде.';
...
$string['configuserquota'] = 'Максимальна обсяг в байтах, що користувач може зберігати у своїй власній файлової області. {$a->bytes} байтів == {$a->displaysize}';
$string['configusesitenameforsitepages'] = 'Якщо включено, то коротка назва сайту буде використана в навігації по сторінках сайту замість рядка \'Сторінки сайту';
...
$string['courserequestnotifyemail'] = 'Користувач {$a->user} запросив новий курс {$a->link}';
...
$string['cronwarning'] = 'Скрипт підтримки <a href="cron.php">cron.php</a> не запускався як мінімум 24 години.';
$string['cronwarningcli'] = 'Сценарій обслуговування cli/cron.php не запускався, принаймні 24 годин.';
...
$string['defaulthomepage'] = 'Типова домашня сторінка користувачів';
...
$string['enablesafebrowserintegration'] = 'Дозволити інтеграцію Безпечного Екзаменаційного Браузера';
...
$string['environmentmariadbwrongdbtype'] = 'Неправильний <code>$CFG->dbtype</code>: вам потрібно змінити його у файлі <code>config.php</code> з \'<code>mysql</code>\' на \'<code>mariadb</code>\'.';
...
$string['execpathnotallowed'] = 'Встановлення шляхів виконання відключених в config.php';
...
$string['frontpagebackup'] = 'Резервна копія';
$string['frontpagedefaultrole'] = 'Типова роль для Головної сторінки';
$string['frontpagefilters'] = 'Фільтри Головної сторінки';
$string['frontpageloggedin'] = 'Головна сторінка після входу на сайт';
$string['frontpagemanagers'] = 'Головна сторінка після входу на сайт менеджера';
$string['frontpageteachers'] = 'Головна сторінка після входу на сайт викладача';
$string['frontpagestudents'] = 'Головна сторінка після входу на сайт студента';
$string['frontpageoverrides'] = 'Зміна прав';
$string['frontpagequestions'] = 'Питання сайту';
$string['frontpagerestore'] = 'Відновлення';
$string['frontpageroles'] = 'Ролі';
$string['frontpagesettings'] = 'Вигляд';
...
$string['installsessionerror'] = 'Не ініціалізується РНР сесія, перевірте, чи включена підтримка кук у вашому браузері.';
...
$string['iplookupinfo'] = 'За замовчуванням Moodle використовує безкоштовний онлайн-сервер NetGeo (The Internet Geographic Database) для пошуку розташування IP-адрес, на жаль, ця база даних більше не підтримується і може повертати вкрай <em>невірні</em> дані.
Рекомендується встановити локальну копію безкоштовної бази даних GeoLite2 City від MaxMind. Розташування IP-адреси відображається на простій карті або за допомогою Google Maps. Зверніть увагу, що вам потрібно мати обліковий запис Google і подати заявку на безкоштовний ключ API Карт Google, щоб увімкнути інтерактивні карти.';
...
$string['logo'] = 'Логотип';
$string['logo_desc'] = 'Повний логотип, який буде використовуватися як прикраса деяких тем (наприклад, основні теми). Це зображення можуть бути досить високою роздільною здатністю, оскільки вони будуть зменшені для використання (і кешовані для виконання). Логотипи, які ширші, ніж вони, зазвичай дають кращі результати. Прийняті формати: PNG і JPG.';
$string['logocompact'] = 'Компактний логотип';
$string['logocompact_desc'] = 'Компактна версія того ж логотипу, що й вище, наприклад, емблема або значок. Зображення має бути чітким навіть при невеликих розмірах. Прийняті формати: PNG і JPG.';
...
$string['maintenancemodeisscheduledlong'] = 'Цей сайт буде переведений на режим обслуговування в {$a->hour} години {$a->min} хв {$a->sec} сек';
...
$string['managelicenses'] = 'Управління ліцензіями';
...
$string['navshowfrontpagemods'] = 'Показувати в навігації елементи головної сторінки';
$string['navshowfrontpagemods_help'] = 'При включеному параметрі елементи головної сторінки будуть відображатися в блоці навігації на сторінках сайту';
...
$string['navshowmycoursecategories_help'] = 'Якщо в ключено, то курси користувача в навігації "Мої курси" будуть відображатися за категоріями.';
...
$string['profilecreatefield'] = 'Створити в профілі нове поле:';
...
$string['profilefieldmaxlength'] = 'Макс. довжина';
...
$string['profilevisible_help'] = '* Не видиме -Для особистих даних, видиме тільки адміністраторам * Видиме для користувача - Для особистих даних, видиме тільки користувачу та адміністраторам * Видиме всім - Всі можуть бачити вказані дані';
...
$string['questioncwqpfscheck'] = 'Одне або більше \'випадкових\' питань в тесті встановлюється вибором питань від змішування загальних і локальних категорій питань. Для більш детального пояснення натисніть <href="{$a->reporturl}">тут</a> або перегляньте сторінку Moodle-документації <href="{$a->docsurl}">тут</a>.';
...
$string['registermoodlenet'] = '<p>Ми хотіли б залишатися на зв\'язку і надавати вам важливі речі для вашого сайту Moodle!</p><p>Зареєструвавшись:</p><ul><li>Ви будете одним з перших, хто дізнається про важливі сповіщення, як-от оповіщення про безпеку та нові випуски Moodle.</li><li>Ви можете отримати доступ та активувати мобільні поштові повідомлення зі свого сайту Moodle через наш безкоштовний <a href="https://download.moodle.org/mobile/">Додаток для мобільних пристроїв Moodle</a>.</li><li>Ви робите свій внесок у наш <a href="https://moodle.net/stats/"> Статистика Moodle </a> світового співтовариства, які допомагають покращити сайти Moodle і наших спільнот.</li><li>Якщо ви бажаєте, ваш сайт може бути включений до <a href="https://moodle.net/sites/"> список зареєстрованих сайтів Moodle</a> у вашій країні.</li></ul>';
$string['registermoodleorg'] = 'При реєстрації свого сайту';
$string['registermoodleorgli1'] = 'Ви будете отримувати поштою повідомлення про попередження системи безпеки та інформацію пор нові версії Moodle.';
$string['registermoodleorgli2'] = 'Статистику вашого сайту буде додано до статистики світової спільноти Moodle.';
...
$string['requestcategoryselection'] = 'Включити вибір категорії';
...
$string['showuseridentity_desc'] = 'Коли шукаєте, або вибираєте користувачів, та коли показується список користувачів, ці поля можуть бути також показані поряд з повним ім’ям. Ця інформація буде показана тільки користувачам з правом moodle/site:viewuseridentity; типово це викладачі та менеджери. (Ця опція має сенс, якщо Ви вибираєте один або два поля, які є обов\'язковими у вашому закладі.)';
...
$string['sitesectionhelp'] = 'Якщо вибрано, то верхня секція буде показуватися на головній сторінці сайту.';
...
$string['supportpage'] = 'Підтримка сторінки';
...
$string['taskbackupcleanup'] = 'Очищення таблиць та журналів резервних копій';
...
$string['unsupportedphpversion7'] = 'PHP версії 7 не підтримується.';
$string['unsupportedphpversion71'] = 'Версія PHP 7.1 не підтримується.';
$string['unsupportedphpversion72'] = 'Версія PHP 7.2 не підтримується.';
$string['unsupportedphpversion73'] = 'PHP версії 7.3 не підтримується.';
$string['unsupportedphpversion74'] = 'PHP версії 7.4 не підтримується.';
$string['unsupportedphpversion80'] = 'PHP версії 8.0 не підтримується.';
...
$string['upgradeerror'] = 'Невідома помилка оновлення {$a->plugin} до версії {$a->version}, продовження неможливе.';
...
$string['webproxyinfo'] = 'Заповніть наступні дані, якщо ваш сервер Moodle не може отримати доступ до інтернет напряму. Інтернет доступ потрібен для завантаження оновлень, мовного пакету, стрічок новин, часових поясів тощо. <br /><em>Наявність PHP cURL дуже рекомендується.</em>';
$string['xmlrpcrecommended'] = 'Розширення XMLRPC корисно для веб-сервісів і мереж Moodle.';
