...
/**
 * Strings for component 'auth_db', language 'uk', version '3.8'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbpasstype'] = '<p>Вкажіть формат, який використовує поле пароля. Шифрування MD5 є корисним для підключення до інших загальнодоступних веб-програм, як PostNuke. </p> <p> Використайте ’Внутрішній’, якщо ви хочете із зовнішньої БД брати ім’я користувача & адресу електронної пошти, але паролем управляти в системі Moodle. Якщо ви використовуєте ’Внутрішній’, ви <i>повинні</i>  заповнити поле адреси електронної пошти у зовнішній БД, також ви повинні регулярно запускати admin/cron.php та auth/db/cli/sync_users.php. Moodle надішле на електронну пошту нових користувачів тимчасовий пароль.';
