...
/**
 * Strings for component 'theme_nimble', language 'uk', version '3.8'.
 *
...
$string['backgroundcolor'] = 'Тло заголовку';
$string['backgroundcolordesc'] = 'Змініть колір тла заголовку.';
$string['choosereadme'] = '<div class="clearfix">
<div class="theme_screenshot">

<h2>Тема оформлення Nimble</h2>
...
<p>Nimble - це проста тема для Moodle 2.0 з двома колонками змінної ширини. Вона дозволяє створювати користувацьке меню, яке розміщується на кожній сторінці над назвою сайту. Тема також включає в основні налаштування зміну кольору гіперпосилань, додавання гасла сайту на головну сторінку, а також текст до нижнього колонтитула.</p>
...
<h2>Розробники</h2>
<p>Ця тема розроблена та підтримується Патріком Моллі (Patrick Malley) з NewSchool Learning (contact@newschoollearning.com). </p>
...
$string['footerline'] = 'Підвалини';
$string['footerlinedesc'] = 'Додайте короткий текст (інформація про авторські права, тощо) в підвалини сторінок сайту.';
...
$string['tagline'] = 'Гасло';
$string['taglinedesc'] = 'Коротке гасло, яке буде виводитися під назвою сайту на головній сторінці.';
