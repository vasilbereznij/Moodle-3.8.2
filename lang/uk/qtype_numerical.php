...
/**
 * Strings for component 'qtype_numerical', language 'uk', version '3.8'.
 *
...
$string['validnumberformats'] = 'Формати дійсних чисел';
$string['validnumberformats_help'] = '* регулярні числа 13500.67 : 13 500.67 : 13500,67: 13 500,67

* Якщо ви використовуєте "," (кому) як роздільник тисяч, то *завжди* пишіть роздільник десяткових знаків "." (крапка) як в 13,500.67 : 13,500.

* для експонентної форми говоримо 1.350067 * 10<sup>4</sup>, використовуйте 1.350067 E4 : 1.350067 E04';
