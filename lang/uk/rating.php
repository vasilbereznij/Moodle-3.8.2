...
/**
 * Strings for component 'rating', language 'uk', version '3.8'.
 *
 * @package     rating
 * @category    string
...
$string['rolewarning_help'] = 'Можливість оцінювання користувачів вимагає права moodle/rating:rate та модуля, який підтримує оцінювання.  Користувачі, яким призначені наступні ролі повинні бути в змозі оцінити елементи. Список ролей може бути змінений за допомогою елементу Права у блоці налаштування.';
