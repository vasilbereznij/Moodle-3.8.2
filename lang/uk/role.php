...
/**
 * Strings for component 'role', language 'uk', version '3.8'.
 *
 * @package     role
 * @category    string
...
$string['archetypefrontpage'] = 'ОРИГІНАЛ: Користувач Головної сторінки';
...
$string['course:setforcedlanguage'] = 'Примусова мова курсу';
...
$string['frontpageuser'] = 'Користувачі Головної сторінки';
$string['frontpageuserdescription'] = 'Всі зареєстровані користувачі в Головній сторінці.';
$string['globalrole'] = 'Глобальна роль';
$string['globalroleswarning'] = 'УВАГА! Всі ролі, які ви призначаєте на цій сторінці будуть поширюватися на весь сайт включно з головною сторінкою та всіма курсами.';
...
$string['roleshortname_help'] = 'Коротка назва ролі є її ідентифікатором, в якому допускаються тільки абетко-цифрові символи ASCII. Не змінюйте короткі назви типових ролей.';
