...
/**
 * Strings for component 'scorm', language 'uk', version '3.8'.
 *
 * @package     scorm
 * @category    string
...
$string['calendarend'] = '{$a} закривається';
$string['calendarstart'] = '{$a} відкритих';
...
$string['duedate'] = 'Кінцевий термін';
...
$string['noattemptsmade'] = 'Кількість спроб, які ви повінні зробити';
