...
/**
 * Strings for component 'certificate', language 'uk', version '3.8'.
 *
 * @package     certificate
 * @category    string
...
$string['borderlines'] = 'Лінія рамки';
$string['borderstyle'] = 'Зображення для межі';
...
$string['printteacher'] = 'Друкувати П.І.Б.  Вчителя';
