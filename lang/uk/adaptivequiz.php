...
/**
 * Strings for component 'adaptivequiz', language 'uk', version '3.8'.
 *
...
$string['answerdistgraph_numrightwrong'] = 'Число неправильне (-) / Число правильне (+)';
$string['answerdistgraph_questiondifficulty'] = 'Рівень запитання';
$string['answerdistgraph_right'] = 'Праворуч';
$string['answerdistgraph_title'] = 'Розподіл відповідей для  {$a->firstname} {$a->lastname}';
$string['answerdistgraph_wrong'] = 'Неправильно';
...
$string['attemptquestion_error'] = 'Стандартна помилка (&plusmn;&nbsp;x%)';
...
$string['errorclosingattempt'] = 'Запис про спробу не знайдено';
$string['errorclosingattempt_alreadycomplete'] = 'Ця спроба вже завершена, її не можна закрити вручну.';
$string['errordeletingattempt'] = 'Запис про спробу не знайдено';
...
$string['graphlegend_target'] = 'Цільовий рівень';
...
$string['na'] = 'н/д';
$string['name'] = 'Ім\'я';
$string['noattemptrecords'] = 'Немає записів спроб цього студента';
...
$string['numright'] = 'Правильний номер';
$string['numwrong'] = 'Неправильний номер';
