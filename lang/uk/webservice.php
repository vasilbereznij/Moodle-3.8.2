...
/**
 * Strings for component 'webservice', language 'uk', version '3.8'.
 *
 * @package     webservice
 * @category    string
...
$string['documentation'] = 'документація цього веб-сервісу';
...
$string['erroroptionalparamarray'] = 'Опис параметру веб-сервісу з ім’ям \'{$a}\'  є одно- або багатоструктурним. Він не може бути VALUE_OPTIONAL. Перевірте опис веб-сервісу.';
...
$string['missingcaps_help'] = 'Сервіс, який обрав користувач, не має необхідних прав. Відсутні права повинні бути додані до ролі користувача для того, щоб скористатися сервісом.';
...
$string['onlyseecreatedtokens'] = 'Будь-який маркер може бути видалений, хоча ви можете переглядати лише маркери, які ви створили.';
