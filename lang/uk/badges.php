...
/**
 * Strings for component 'badges', language 'uk', version '3.8'.
 *
 * @package     badges
 * @category    string
...
$string['addbackpack'] = 'Додайте торбинку';
...
$string['backpackbadges'] = 'Ви маєте {$a->totalbadges} відзнак(у) з {$a->totalcollections} колекцій(Ї). <a href="mybackpack.php">Змінити налаштування торбинки відзнак</a>.';
...
$string['backpackconnection'] = 'З’єднання з торбинкою відзнак';
$string['backpackconnection_help'] = 'Підключення до рюкзака дає вам змогу ділитися своїми значками з цього сайту та відображати загальнодоступні колекції значків із вашого рюкзака на сторінці вашого профілю на цьому сайті.';
...
$string['backpackconnectionunexpectedresult'] = 'Під час підключення до торбинки виникла проблема. Перевірте облікові дані та повторіть спробу.';
...
$string['backpackemailverifyemailbody'] = 'Привіт,

За допомогою вашої адреси електронної пошти було надіслано запит на нове підключення до вашої торбинки з відзнаками.

Щоб підтвердити та активувати підключення до вашої торбинки, перейдіть до

{$ a-> посилання}

У більшості поштових програм це повинно виглядати як синє посилання, на яке можна просто натиснути. Якщо це не спрацює, виріжте та вставте адресу у рядок адреси у верхній частині веб -переглядача.
...
$string['backpackemailverifypending'] = 'Електронний лист із підтвердженням надіслано на адресу <strong> {$ a} </strong>. Натисніть на посилання для підтвердження в електронному листі, щоб активувати з\'єднання для торбинки.';
$string['backpackemailverifysuccess'] = 'Дякуємо, що підтвердили свою електронну адресу. Тепер ви підключені до торбинки.';
...
$string['backpackneedsupdate'] = 'Торбинка, підключена до цього профілю, не відповідає торбинці для сайту. Потрібно від\'єднати та знову підключити торбинку.';
...
$string['badgeimage_help'] = 'Це картинка, яка буде використана при присудженні відзнаки.

Для додавання нової картинки знайдіть та вкажіть файл (у форматі JPG або PNG) та натисніть "Зберегти зміни". Зображення буде обрізане в квадрат та змінить розмір, щоб відповідати вимогам зображення відзнаки.';
...
$string['badgestatus_0'] = 'Недоступно користувачам';
$string['badgestatus_1'] = 'Доступно користувачам';
$string['badgestatus_2'] = 'Недоступно користувачам';
$string['badgestatus_3'] = 'Доступно користувачам';
...
$string['criteria_descr_0'] = 'Користувачі нагороджуються цією відзнакою, коли вони виконали <strong>{$a}</strong> з перерахованих вимог.';
...
$string['editsettings'] = 'Редагувати налаштування';
...
$string['error:backpacknotavailable'] = 'Ваш сайт недоступний з інтернету, тому будь-які відзнаки отримані на цьому сайті не можуть бути викладені в зовнішні торбинки відзнак.';
$string['error:backpackproblem'] = 'Виникли проблеми при з’єднанні з сервісом вашої торбинки відзнак. Будь ласка, спробуйте ще раз пізніше.';
...
$string['error:invalidbadgeurl'] = 'Хибний формат URL видавця відзнаки.';
...
$string['error:nogroups'] = '<p>Немає відкритих колекцій відзнак доступних у вашій торбинці. </p> <p>Показуються лише публічні колекції.  <a href="http://backpack.openbadges.org">Завітайте до вашої торбинки</a> для створення відкритих колекцій.</p>';
...
$string['nobackpackbadges'] = 'Немає відзнак у вибраних вами колекціях. <a href="mybackpack.php">Додати ще колекції</a>.';
$string['nobackpackbadgessummary'] = 'У вибраних колекціях немає відзнак.';
$string['nobackpackcollections'] = 'Не вибрано колекції відзнак. <a href="mybackpack.php">Додати колекції</a>.';
$string['nobackpackcollectionssummary'] = 'Не вибрано жодної колекції відзнак.';
$string['nobackpacks'] = 'Торбинок немає';
$string['nobadges'] = 'Немає доступних відзнак.';
...
$string['recipientvalidationproblem'] = 'Не вдається перевірити поточного користувача в якості отримувача цієї відзнаки.';
...
$string['sitebackpack'] = 'Активна зовнішня торбинка';
$string['sitebackpack_help'] = 'Зовнішня торбинка, до якої користувачі можуть підключитися з цього сайту. Зверніть увагу, що зміна цього налаштування після того, як користувачі під’єднали торбинки, вимагатиме, щоб кожен користувач перейшов на сторінку налаштувань торбинки та від’єднався, а потім знову підключився.';
$string['sitebackpackverify'] = 'Підключення до торбинки';
$string['sitebackpackwarning'] = 'Не вдалося підключитися до торбинки. <br/> <br/> Перевірте, чи налаштування адміністратора "Електронна адреса видавця відзнаки" є дійсною електронною адресою для облікового запису на веб-сайті торбинки. <br/> <br/> Перевірте, чи "пароль видавця відзнаки" на <a href="{$a-> url} "> сторінці налаштувань торбинки сайту </a> є правильним паролем для облікового запису на веб-сайт для торбинок. <br/> <br/> Рюкзак повернув: "{$ a-> warning}"';
