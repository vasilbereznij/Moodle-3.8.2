...
/**
 * Strings for component 'feedback', language 'uk', version '3.8'.
 *
 * @package     feedback
 * @category    string
...
$string['configallowfullanonymous'] = 'Якщо ця опція встановлена в Так, то зворотний зв’язок може бути здійсненим без процедури входження. Можливе тільки на головній сторінці.';
...
$string['do_not_analyse_empty_submits'] = 'Не аналізувати порожні відповіді';
