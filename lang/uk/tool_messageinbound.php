...
/**
 * Strings for component 'tool_messageinbound', language 'uk', version '3.8'.
 *
...
$string['configmessageinboundhost'] = 'Адреса сервера, на якому Moodle повинен перевіряти пошту. Щоб задати не типовий порт, ви можете використати формат [сервер]:[порт]; наприклад, mail.example.com:587. Якщо залишити це поле порожнім, то Moodle буде використовувати типовий порт для вказаного типу поштового сервера.';
