...
/**
 * Strings for component 'theme_splash', language 'uk', version '3.8'.
 *
...
<h2>Тема оформлення Splash</h2>
<img src="splash/pix/screenshot.png" />
...
<p>Splash - це тема для Moodle з трьома колонками змінної ширини. </p>
...
<h2>Розробники</h2>
<p>Ця тема спрограмована та підтримується Каролін Кеннеді (Caroline Kennedy) з Synergy Learning (caroline.kennedy@synergy-learningw.com). </p>
...
$string['configtitle'] = 'Тема Splash Theme';
...
$string['defaulttagline'] = 'Віртуальний навчальний центр';
$string['footnote'] = 'Підвалини';
$string['footnotedesc'] = 'Додане в текстову область буде виведено в нижній частині кожної сторінки.';
$string['hide_tagline'] = 'Приховати гасло';
$string['hide_taglinedesc'] = 'Встановіть відмітку, щоб приховати гасло під логотипом.';
$string['loginhere'] = 'Вхід тут!';
$string['logo'] = 'Логотип';
$string['logodesc'] = 'Додайте URL-адресу нового логотипу, якщо ви хочете замінити стандартний логотип цієї теми. Повинен мати вигляд типу http://www.yoursite.com/path/to/logo.png. Логотип повинен мати максимум 230px у ширину.';
$string['pluginname'] = 'Splash';
$string['region-side-post'] = 'Праворуч';
$string['region-side-pre'] = 'Ліворуч';
$string['tagline'] = 'Гасло';
$string['taglinedesc'] = 'Коротке гасло, яке буде виводитися під логотипом сайту на головній сторінці.';
$string['usergreeting'] = 'Вітаємо, {$a}!';
